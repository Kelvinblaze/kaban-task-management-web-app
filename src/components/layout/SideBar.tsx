...
const SideBar = ({ isOpen, setIsOpen }: SideBarProps) => {
  ...
  return (
    <div className="relative hidden md:block">
      {isOpen && (
        <aside
          className={`transition-transform duration-300 ease-in-out lg:min-w-[300px] md:min-w-[250px] md:max-w-[300px] w-max border-r py-5 h-screen bg-white dark:bg-dark-grey border-r-lines-light dark:border-r-lines-dark flex flex-col justify-between  ${
      ...
      {!isOpen && (
        <button
          type="button"
          className="cursor-pointer bg-main-purple text-white rounded-r-full p-5 absolute bottom-10 font-bold"
          onClick={() => {
            setIsOpen(true);
          }}
